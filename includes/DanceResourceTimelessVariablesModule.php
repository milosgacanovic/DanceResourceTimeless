 ...
 */
class DanceResourceTimelessVariablesModule extends SkinModule {
	/**
	...
	protected function getLessVars( Context $context ) {
		...
		// Backdrop image
		$backdrop = $config->get( 'DanceResourceTimelessBackdropImage' );
	...
	public function getDefinitionSummary( Context $context ) {
		...
		$summary[] = [
			'DanceResourceTimelessBackdropImage' => $this->getConfig()->get( 'DanceResourceTimelessBackdropImage' )
		];
		return $summary;
	}
}
